...
class CrearNotaCredito(LoginRequiredMixin, View):
    ...
    def get(self, request, factura_id):
        ...
        # Obtener opciones y siguiente secuencial
        opciones = Opciones.objects.for_tenant(empresa).first()
        establecimiento = opciones.establecimiento if opciones else '001'
        punto_emision = opciones.punto_emision if opciones else '001'
